...
function AddCityToDestinationStack(city: table)
    ...
    local tooltipString = ("总计[ICON_Turn]回合数来完成该贸易路线[NEWLINE]" ..
            "--------------------------------------------------------[NEWLINE]" ..
            "贸易路线距离[ICON_Movement]: " .. tradePathLength .. "[NEWLINE]" ..
            "往返次数: " .. tripsToDestination .. "[NEWLINE]" ..
            "如果开始，路线将会在第[ICON_Turn]: " .. Game.GetCurrentGameTurn() + turnsToCompleteRoute) .. "结束";
