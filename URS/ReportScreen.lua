    ...
    for _, unit in player:GetUnits():Members() do
        ...
        if kUnitData["Unit_Report"][group_name] == nil then
            if group_name == "GREAT_PERSON" then
                kUnitData["Unit_Report"][group_name] = { Name = Locale.Lookup("LOC_HUD_UNITS_Great_People"), ID = 6, func = group_great, Header = "UnitsGreatPeopleHeaderInstance", Entry = "UnitsGreatPeopleEntryInstance", units = {} }
            elseif group_name == "SPY" then
                kUnitData["Unit_Report"][group_name] = { Name = Locale.Lookup("LOC_HUD_UNITS_Spy"), ID = 8, func = group_spy, Header = "UnitsSpyHeaderInstance", Entry = "UnitsSpyEntryInstance", units = {} }
            elseif group_name == "RELIGIOUS" then
                kUnitData["Unit_Report"][group_name] = { Name = Locale.Lookup("LOC_HUD_UNITS_Religious"), ID = 5, func = group_religious, Header = "UnitsReligiousHeaderInstance", Entry = "UnitsReligiousEntryInstance", units = {} }
            elseif group_name == "TRADER" then
                kUnitData["Unit_Report"][group_name] = { Name = Locale.Lookup("LOC_HUD_UNITS_Trader"), ID = 7, func = group_trader, Header = "UnitsTraderHeaderInstance", Entry = "UnitsTraderEntryInstance", units = {} }
            elseif group_name == "MILITARY_LAND" then
                kUnitData["Unit_Report"][group_name] = { Name = Locale.Lookup("LOC_HUD_UNITS_Military_Land"), ID = 1, func = group_military, Header = "UnitsMilitaryHeaderInstance", Entry = "UnitsMilitaryEntryInstance", units = {} }
            elseif group_name == "MILITARY_AIR" then
                kUnitData["Unit_Report"][group_name] = { Name = Locale.Lookup("LOC_HUD_UNITS_Military_Air"), ID = 3, func = group_military, Header = "UnitsMilitaryHeaderInstance", Entry = "UnitsMilitaryEntryInstance", units = {} }
            elseif group_name == "MILITARY_SEA" then
                kUnitData["Unit_Report"][group_name] = { Name = Locale.Lookup("LOC_HUD_UNITS_Military_Sea"), ID = 2, func = group_military, Header = "UnitsMilitaryHeaderInstance", Entry = "UnitsMilitaryEntryInstance", units = {} }
            else
                kUnitData["Unit_Report"][group_name] = { Name = Locale.Lookup("LOC_HUD_UNITS_Civilian_Support"), ID = 4, func = group_civilian, Header = "UnitsCivilianHeaderInstance", Entry = "UnitsCivilianEntryInstance", units = {} }
            end
        end
...
function ViewYieldsPage()
    ...
    for cityName, kCityData in pairs(m_kCityData) do
        ...
        if (iNumDistricts > 0) then
            ...
            pBuildingInstance.BuildingName:SetText(Locale.Lookup("LOC_DISTRICT_CITY_CENTER_NAME"))
    ...
    instance = NewCollapsibleGroupInstance();
    instance.RowHeaderButton:SetText(Locale.Lookup("LOC_HUD_UNITS_Unit_Expenses"));
...
function ViewDealsPage()
    ...
    for j, pDeal in spairs(m_kCurrentDeals, function(t, a, b) return t[b].EndTurn > t[a].EndTurn end) do
        ...
        instance.RowHeaderButton:SetText(pDeal.WithCivilization)
        instance.RowHeaderLabel:SetText(ending .. " " .. turns .. " (" .. pDeal.EndTurn .. ")")
        ...
        pFooterInstance.Outgoing:SetText(Locale.Lookup("LOC_HUD_TRADETOTAL") .. " : " .. #pDeal.Sending)
        pFooterInstance.Incoming:SetText(Locale.Lookup("LOC_HUD_TRADETOTAL") .. " : " .. #pDeal.Receiving)
