...
local TQUI_bigMinimap = false;
-- ===========================================================================
--  FUNCTIONS
-- ===========================================================================


--TQUI Minimap size toggling logic
function TQUI_ToggleMinimapSize()
  TQUI_bigMinimap = not TQUI_bigMinimap;
  if(TQUI_bigMinimap) then
...
function ToggleMapPinMode()
  ...
  --for test getseedseed 
  --Controls.MapPinListButton:SetToolTipString("MapRandSeed="..tostring(Network.GetMapRandSeed()));
  --print("MapRandSeed="..tostring(Network.GetMapRandSeed());
  --print("MapSynchRandSeed="..(Network.GetSynchRandSeed());
  -- unknown or locked
